...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (expand-region hungry-delete beacon yasnippet-snippets yasnippet jedi which-key use-package try ox-reveal org-bullets htmlize flycheck dracula-theme counsel auto-complete ace-window))))
(custom-set-faces
